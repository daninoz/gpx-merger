<template>
  <ul
    class="collection"
    :class="{ active: $store.state.activeRoute === index }"
  >
    <li
...
export default {
  ...
  methods: {
    deletePoint(pointIndex) {
      this.$store.dispatch('delete-point', {pointIndex, routeIndex: this.index})
    },

    deleteAfterPoint(pointIndex) {
      this.$store.dispatch('delete-after-point', {pointIndex, routeIndex: this.index})
    },

    deleteBeforePoint(pointIndex) {
      this.$store.dispatch('delete-before-point', {pointIndex, routeIndex: this.index})
    },
